...
public class ChatClient extends JFrame implements Runnable 
{
	...
	public static void main(String[] argv) throws IOException {
		...
		System.out.println("Connecting to Chat Server at " + clientAddress + "...");

		ChatClient client = new ChatClient(clientAddress, portNumber);
		client.pack();
		client.setLocation(15,1);
		client.setVisible(true);
	}

	public ChatClient(InetAddress address, int portNumber) {
		super( "Vish Chat!" );
